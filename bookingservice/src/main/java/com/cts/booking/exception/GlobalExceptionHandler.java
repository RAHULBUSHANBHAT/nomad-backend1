...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<String> handleBookingException(BookingException ex) {
        log.warn("BookingException: {}", ex.getMessage());
    ...
    public ResponseEntity<String> handleFeignException(FeignException ex) {
        ...
        return new ResponseEntity<>("A downstream service is unavailable or returned an error.", HttpStatus.SERVICE_UNAVAILABLE);
    }
